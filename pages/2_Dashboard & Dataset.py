...
html_title = """
    ...
    <center><h5 class="title-test">2020 and 2021</h5></center>"""
with col2:
...
with col5:
    fig1 = px.line(result, x = "Month_Year", y = "TotalSales", title="Total Sales Over Time",
                   template="gridon",color_discrete_sequence=['yellow'])
...
treemap_layout = {
    'paper_bgcolor': 'rgba(0, 137, 132, 1)',  # Couleur du fond du graphique
    'plot_bgcolor': 'rgba(0,0,1,1)',   # Couleur du fond du tracé
}
...
with col7:
    ...
    fig4.update_layout(treemap_layout)
